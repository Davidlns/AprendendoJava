...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Os elementos no ArrayList: " + lst_numeros);
        ...
        lst_numeros.remove(1); // Remove o elemento da posição 2 de ArrayList
        ...
        int k=0;
        System.out.println("\nOs elementos no ArrayList: " + lst_numeros);
